...
char *usage = "Parallel Usage: mpirun -n 8 ./multi_pre_write -g 64x64x64 -l 32x32x32 -p 40x40x40 -v 2 -t 4 -f output_file_name -z 1 -c 0 -o 4 -m 1\n"
                     "  -g: global dimensions\n"
...
static void parse_args(int argc, char **argv)
{
  char flags[] = "g:l:p:i:f:t:v:o:z:c:m:d:";
  int one_opt = 0;
