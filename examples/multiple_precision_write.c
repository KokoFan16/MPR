...
char *usage = "Parallel Usage: mpirun -n 8 ./multi_pre_write -g 64x64x64 -l 32x32x32 -p 40x40x40 -v 2 -t 4 -f output_file_name -z 1 -c 0 -n 4 -o 4 -m 1 -e 1\n"
                     "  -g: global dimensions\n"
...
int main(int argc, char **argv)
{
	...
	size_buffer = malloc(time_step_count * 5 * variable_count * sizeof(long long int));
