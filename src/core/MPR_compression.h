...
MPR_return_code MPR_decompress_3D_data(unsigned char* buf, int size, int dim_x, int dim_y, int dim_z, int flag, float param, int data_type, MPR_zfp_compress* output);
