...
//		{
//			Events e("recv", "null");
		CALI_CXX_MARK_LOOP_BEGIN(recvloop_id, "recv");
...
//			Events e("send", "comm");
		...
		CALI_CXX_MARK_LOOP_END(sendloop_id);
